...
/*   Updated: 2020/01/26 15:02:00 by dorange-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_gui_draw_map(t_wolf3d *w, t_list *list)
{
	...
	elem = list->content;
	ft_gui_draw_map_grid_limit_sector(w, elem, w->gui_map.r1, GUI_MAP_GRID_LIMIT_TL);
	ft_gui_draw_map_grid_limit_sector(w, elem, w->gui_map.r2, GUI_MAP_GRID_LIMIT_BR);
	ft_gui_draw_map_grid(w, elem, w->gui_map.grid_scale);
	ft_gui_draw_map_grid_limit_line(w, elem, w->gui_map.r1, w->gui_map.grid_scale);
	ft_gui_draw_map_grid_limit_line(w, elem, w->gui_map.r2, w->gui_map.grid_scale);
