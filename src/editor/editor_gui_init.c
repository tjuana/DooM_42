...
/*   Updated: 2020/02/10 17:42:18 by dorange-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_gui_init_win_menu_add(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_menu_title", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 60, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_btnsector", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 100, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_btnplayer", \
		(t_gui_coord){WIN_WIDTH - 150 + 5, 100, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_btndoor", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 150, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_btnsprite", \
		(t_gui_coord){WIN_WIDTH - 150 + 5, 150, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_btnenemy", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 200, 0}, \
...
void	ft_gui_init_win_menu_set(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_menu_title", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 280, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 320, 0});
	ft_gui_elem_set_color(elem->child, 0xcccccc);
	ft_gui_elem_set_text(elem->child, "Set:", 16);
	ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_menu_btntxtr", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 320, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_btnskybox", \
		(t_gui_coord){WIN_WIDTH - 150 + 5, 320, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_btnendplace", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 370, 0}, \
...
void	ft_gui_init_win_menu_save(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_menu_titleinput", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 200, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_inputmapname", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 160, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 120, 0});
	ft_gui_elem_set_color(elem->child, 0xaaaaaa);
	ft_gui_elem_set_input(elem->child, " ", 0);
	ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_menu_btnsavemap", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 110, 0}, \
	...
	ft_gui_elem_init(&elem->child, "win_editor_menu_btnmenu", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 60, 0}, \
...
void	ft_gui_init_win_menu(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_menu_title", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 5, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 45, 0});
	ft_gui_elem_set_color(elem->child, 0xffffff);
	ft_gui_elem_set_text(elem->child, "M A P   E D I T O R", 16);
	ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_menu_hr", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 47, 0}, \
...
void	ft_gui_init_win_setsector(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_setsector_title", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 5, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 45, 0});
	...
	// Установка текстур (будем ли реализовывать?)
	// ft_gui_elem_init(&elem->child, "win_setsector_walltxtr",
	//	(t_gui_coord){WIN_WIDTH - 300 + 20, 50, 0},
	// 	(t_gui_coord){WIN_WIDTH - 20, 310, 0});
	// ft_gui_elem_set_color(elem->child, 0x000000);
	// ft_gui_elem_set_redraw(elem->child, ft_editor_redraw_txtr);
	// ft_gui_elem_set_event(elem->child,
	//		ft_gui_mousebuttonup_win_setsector_walltxtr, SDL_MOUSEBUTTONUP, 0);
	// // ft_gui_elem_set_block(elem->child);
	// ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_setsector_titleinputfloor", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 400, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 440, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	ft_gui_elem_set_text(elem->child, "Floor:", 16);
	ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_setsector_inputfloor", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 440, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 480, 0});
	ft_gui_elem_set_color(elem->child, 0x333333);
	ft_gui_elem_set_input(elem->child, "0", 1);
	ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_setsector_titleinputheight", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 500, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 540, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	ft_gui_elem_set_text(elem->child, "Height:", 16);
	ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_setsector_inputheight", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 540, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 580, 0});
	ft_gui_elem_set_color(elem->child, 0x333333);
	ft_gui_elem_set_input(elem->child, "0", 1);
	ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_setsector_btnsavemap", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 110, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 70, 0});
	ft_gui_elem_set_color(elem->child, 0x50c878);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setsector_btncancel", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 60, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 20, 0});
...
void	ft_gui_init_win_setplayer(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_setplayer_btntitle", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 5, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 45, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setplayer_playervec", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 50, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 310, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	ft_gui_elem_set_block(elem->child);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setplayer_btnsaveplayer", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 110, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 70, 0});
	ft_gui_elem_set_color(elem->child, 0x50c878);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setplayer_btncancel", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 60, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 20, 0});
	ft_gui_elem_set_color(elem->child, 0xcc0605);
	ft_gui_elem_set_button(elem->child, "Cancel");
...
void	ft_gui_init_win_setsprite(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_setsprite_btntitle", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 5, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 45, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	ft_gui_elem_set_text(elem->child, "Set player", 16);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setsprite_playervec", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 50, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 310, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	ft_gui_elem_set_block(elem->child);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setsprite_btnsaveplayer", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 110, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 70, 0});
	ft_gui_elem_set_color(elem->child, 0x50c878);
	ft_gui_elem_set_button(elem->child, "Save player");
	...
	ft_gui_elem_init(&elem->child, "win_editor_setsprite_btncancel", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 60, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 20, 0});
	ft_gui_elem_set_color(elem->child, 0xcc0605);
	ft_gui_elem_set_button(elem->child, "Cancel");
...
void	ft_gui_init_win_setenemy(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_setenemy_btntitle", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 5, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 45, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	ft_gui_elem_set_text(elem->child, "Set player", 16);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setenemy_playervec", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 50, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 310, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	ft_gui_elem_set_block(elem->child);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setenemy_btnsaveplayer", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 110, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 70, 0});
	ft_gui_elem_set_color(elem->child, 0x50c878);
	ft_gui_elem_set_button(elem->child, "Save player");
	...
	ft_gui_elem_init(&elem->child, "win_editor_setenemy_btncancel", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 60, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 20, 0});
	ft_gui_elem_set_color(elem->child, 0xcc0605);
	ft_gui_elem_set_button(elem->child, "Cancel");
...
void	ft_gui_init_win_setdoor(t_list *head)
{
	...
	elem = head->content;
	ft_gui_elem_init(&elem->child, "win_editor_setdoor_title", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 5, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 45, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setdoor_text", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, 45, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, 45, 0});
	ft_gui_elem_set_color(elem->child, 0x000000);
	ft_gui_elem_set_text(elem->child, "Draw line between two sector walls", 16);
	ft_gui_elem_set_parent(head, elem->child);

	ft_gui_elem_init(&elem->child, "win_editor_setdoor_btnsave", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 110, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 70, 0});
	ft_gui_elem_set_color(elem->child, 0x50c878);
	...
	ft_gui_elem_init(&elem->child, "win_editor_setdoor_btncancel", \
		(t_gui_coord){WIN_WIDTH - 300 + 20, WIN_HEIGHT - 60, 0}, \
		(t_gui_coord){WIN_WIDTH - 20, WIN_HEIGHT - 20, 0});
	ft_gui_elem_set_color(elem->child, 0xcc0605);
	ft_gui_elem_set_button(elem->child, "Cancel");
