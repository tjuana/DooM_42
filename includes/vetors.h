...
/*   Updated: 2020/01/21 19:21:45 by tjuana           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#  define V4D typedef double t_v4df __attribute__((vector_size(32),aligned))
#  define V2D typedef double t_v2df __attribute__((vector_size(16),aligned))
#  define V4U typedef size_t t_v4du __attribute__((vector_size(32),aligned))
